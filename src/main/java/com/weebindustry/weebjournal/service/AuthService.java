...
import com.weebindustry.weebjournal.models.VerificationToken;
...
public class AuthService {
    ...
    public void signUp(RegisterRequest registerRequest) {
        ...
        mailService.sendMail(new NotificationEmail("Please Activate your Account", user.getEmail(),
                "Thank you for signing up to WeebJournal!, "
                        + "please click on the below url to activate your account : "
                        + "http://localhost:1408/api/auth/accountVerification/" + token));
    }
    ...
    private void fetchUserAndEnable(VerificationToken verificationToken) {
        ...
        User user = userRepository.findByUsername(username)
                .orElseThrow(() -> new WeebJournalException("User not found with name - " + username));
    ...
    public void verifyAccount(String token) {
        ...
        fetchUserAndEnable(verificationToken.orElseThrow(() -> new WeebJournalException("Invalid Token")));
    }
